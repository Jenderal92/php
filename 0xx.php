...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="https://firebase.google.com/images/products/icons/build_app_check.svg">
    ...
    <style>
      body {
        ...
        .drop {
            position: absolute;
            background: linear-gradient(180deg, #E02626, #E02626);
            width: 1.5px;
            height: 20px;
            opacity: 0.6;
...
<div id="container">
<h2><a href="?" style="text-decoration:none;color: #E02626;">BERAK</a></h2>
...
<h4 style="color:#E02626; text-align: center; margin: 20px auto; width: 100%; max-width: 100%; font-size: 1rem;">&copy; BERAK</h4>
</body>
</html>
